...
export class MealSubscriptionController {
  constructor(private readonly mealSubscriptionService: MealSubscriptionService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateMealSubscriptionDto: UpdateMealSubscriptionDto) {
